  ...
  <body background = "image/background.jpg">
	...
	<div class="row" style="background-color:transparent;">
		...
		<ul class="nav nav-tabs">
		  <li class="active"><a href="Main2.php" style="color:black;">Home</a></li>
		  ...
		  <li><a href="kirim-gambar.php" style="color:black;">Upload Gambar</a></li>
		  <li><a href="Main2-tentang.php" style="color:black;">Tentang Kami</a></li>
	...
	<?php include "include/contain/home.php"; ?>
